...
const solutions = [
  { id: "website", style: "bg-purple-100 text-purple-600", icon: <Globe2 className="w-5 h-5" />, title: "Site Profissional" },
  { id: "email_corp", style: "bg-emerald-100 text-emerald-600", icon: <Mail className="w-5 h-5" />, title: "Email Corporativo" },
  { id: "cloud_server", style: "bg-sky-100 text-sky-600", icon: <Cloud className="w-5 h-5" />, title: "Servidor em Nuvem" },
  { id: "management_system", style: "bg-amber-100 text-amber-600", icon: <Server className="w-5 h-5" />, title: "Sistema de Gestão" },
  { id: "whatsapp", style: "bg-fuchsia-100 text-fuchsia-600", icon: <MessageCircleMore className="w-5 h-5" />, title: "WhatsApp Business" },
  { id: "ia", style: "bg-rose-100 text-rose-600", icon: <Brain className="w-5 h-5" />, title: "Inteligência Artificial" },
  { id: "marketsing", style: "bg-cyan-100 text-cyan-600", icon: <MonitorSmartphone className="w-5 h-5" />, title: "Marketing Digital" },
]
// const solutions = [
  ...
  return (
    <div className="flex gap-3 mt-4 md:mt-6">
      {solutions.map((item) => {
        ...
        return (
          <div key={item.id} className={`p-4 rounded-xl border ${isActive ? "border-emerald-200" : "border-surface"}`}>
            <div className="flex flex-col gap-2">
              {/* <div className="  items-center justify-between "> */}
              <div className="">
                {/* <div className="flex flex-col items-center justify-center text-center gap-2"> */}
                <div className={`mx-auto w-8 h-8 rounded-full flex items-center justify-center ${item.style}`}>
                  {item.icon}
                </div>
                <div>
              ...
              <div className="mx-auto">
                ...
                {isActive ? (
                  ...
                  <Link href="https://api.whatsapp.com/send?phone=551530420727" className="flex items-center justify-center gap-1 px-3 py-1.5 rounded-lg text-xs bg-accent text-light">
                    Contratar
