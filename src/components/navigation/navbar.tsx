...
import { Globe2, Headphones, LayoutDashboard, MonitorSmartphone, Receipt, Server, SlidersHorizontal } from "lucide-react"
...
export function NavBar({ company }: { company: Company }) {
  ...
  const routes: NavItemProps[] = [
    ...
    { icon: <Receipt className="w-5 h-5" />, name: "Boletos", url: "/dashboard/billing", visible: false },
